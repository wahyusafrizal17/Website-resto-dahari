                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.menu.index') }}">Menu</a>
                                </li>
                                 ...
                                 <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td>{{ $row->harga }}</td>
                                          <td>
                                             <img src="{{ asset('menu/'.$row->foto) }}" width="100%" alt="">
                                          </td>
                                          <td>{{ $row->deskripsi }}</td>
                                         <td class="text-center">
                                             <div class="form-button-action">
                                                <a href="{{ route('admin.menu.edit',[$row->id]) }}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-sm" data-original-title="Edit">
